                            ...
                            <div className="bg-black p-[20px] md:p-[40px] m-0 h-[80%] pt-[30px] w-[80%] relative transform overflow-y-auto rounded-lg bg-white-700 text-left shadow-xl transition-all box_shadow">
                                ...
                                <div className=' mt-[10px] grid grid-cols-1 md:grid-cols-2'>
                                    ...
                                    <div className='md:ml-8 '>
                                        ...
                                        <div className='grid grid-cols-1 lg:grid-cols-2 mt-[30px]'>
                                            <a className='box_shadow lg:w-[200px] text-[#fd7014] flex items-center cursor-pointer' href='https://tesla-clone-b0e1e.web.app/' alt="" target='_blank' rel="noreferrer"><RiLink className='mr-[10px]' color='white' />Live</a>
                                            <a className='box_shadow my-[30px] lg:my-0 lg:w-[200px] text-[#fd7014] flex items-center cursor-pointer' href='https://github.com/munnokd/Tesla-UI' alt="" target='_blank' rel="noreferrer"><SiGithub className='mr-[10px]' color='white' />Github </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-black p-[20px] md:p-[40px] m-0 h-[80%] pt-[30px] w-[80%] relative transform overflow-y-auto rounded-lg bg-white-700 text-left shadow-xl transition-all box_shadow">
                                ...
                                <div className=' mt-[10px] grid grid-cols-1 md:grid-cols-2'>
                                    ...
                                    <div className='md:ml-8 '>
                                        ...
                                        <div className='grid grid-cols-1 lg:grid-cols-2 mt-[30px]'>
                                            <a className='box_shadow lg:w-[200px] text-[#fd7014] flex items-center cursor-pointer' href='https://projest.vercel.app/' alt="" target='_blank' rel="noreferrer"><RiLink className='mr-[10px]' color='white'/>Live</a>
                                            <a className='box_shadow my-[30px] lg:my-0 lg:w-[200px] text-[#fd7014] flex items-center cursor-pointer' href='https://github.com/munnokd/Projest' alt="" target='_blank' rel="noreferrer"><SiGithub className='mr-[10px]' color='white' />Github </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-black p-[20px] md:p-[40px] m-0 h-[80%] pt-[30px] w-[80%] relative transform overflow-y-auto rounded-lg bg-white-700 text-left shadow-xl transition-all box_shadow">
                                ...
                                <div className=' mt-[10px] grid grid-cols-1 md:grid-cols-2'>
                                    ...
                                    <div className='md:ml-8 '>
                                        ...
                                        <div className='grid grid-cols-1 lg:grid-cols-2 mt-[30px]'>
                                            <a className='box_shadow lg:w-[200px] text-[#fd7014] flex items-center cursor-pointer' href='https://resume-generator-xi.vercel.app/' alt="" target='_blank' rel="noreferrer"><RiLink className='mr-[10px]' color='white' />Live</a>
                                            <a className='box_shadow my-[30px] lg:my-0 lg:w-[200px] text-[#fd7014] flex items-center cursor-pointer' href='https://github.com/munnokd/Resume-Genrator' alt="" target='_blank' rel="noreferrer"><SiGithub className='mr-[10px]' color='white' />Github </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
